...
Config::define('S3_UPLOADS_HTTP_CACHE_CONTROL', 30 * 24 * 60 * 60); // will expire in 30 days time
...
Config::define('WP_REDIS_TIMEOUT', env('WP_REDIS_TIMEOUT'));
Config::define('WP_REDIS_READ_TIMEOUT', env('WP_REDIS_READ_TIMEOUT'));
Config::define('WP_REDIS_DISABLE_DROPIN_CHECK', true);
